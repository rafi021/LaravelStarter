                    ...
                    <form class="text-left" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form">
                            <div id="email-field" class="field-wrapper input">
                                ...
                                <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="e.g john.doe@gmail.com">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="social">
                                <a href="{{ route('login.login.provider', ['provider' => 'google']) }}" class="btn social-fb">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chrome"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="4"></circle><line x1="21.17" y1="8" x2="12" y2="8"></line><line x1="3.95" y1="6.06" x2="8.54" y2="14"></line><line x1="10.88" y1="21.94" x2="15.46" y2="14"></line>
                                    Google</svg>
                                </a>
                               <a href="{{ route('login.login.provider', ['provider' => 'github']) }}" class="btn social-github">
